...
('Admin User', 'admin@grocery.com', '$2a$10$gaTL1Fl9kFf.WKqOFKbRJ.AT3DEerVq0mChzyPGq0eL3yeZXTA2Sy', 'Admin Office, City', 9999999999, 'ADMIN'),
...
INSERT INTO product (product_name, price, quantity, product_description, image_url) VALUES
('Fresh Apples', 2.99, 100, 'Red delicious apples', 'https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=400'),
('Organic Bananas', 1.99, 150, 'Fresh organic bananas', 'https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=400'),
('Whole Milk', 3.49, 50, 'Fresh whole milk 1 gallon', 'https://images.unsplash.com/photo-1563636619-e9143da7973b?w=400'); 